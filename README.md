...
[![gzip size](https://img.shields.io/badge/gzip%20size-430%20B-a8f.svg)](https://cdn.jsdelivr.net/npm/scrolls.js@1.0.13/scrolls.min.js?compression=gzip)

[scrolls.js](https://scrollsjs.com) is a tiny [library](https://cdn.jsdelivr.net/npm/scrolls.js@1.0.13/scrolls.min.js?compression=gzip) to help provide smooth scrolling functionality for those that do not currently use another solution.
...
A smooth scrolling [library](https://cdn.jsdelivr.net/npm/scrolls.js@1.0.13/scrolls.min.js?compression=gzip) built to provide convenience for developers.

Visit the landing page at [scrollsjs.com](https://scrollsjs.com) to see a [demo](https://scrollsjs.com) of the [library](https://cdn.jsdelivr.net/npm/scrolls.js@1.0.13/scrolls.min.js?compression=gzip) in action!
...
You can install the [library](https://cdn.jsdelivr.net/npm/scrolls.js@1.0.13/scrolls.min.js?compression=gzip) via npm:
...
```html
<!-- Source Version -->
<script src="https://cdn.jsdelivr.net/npm/scrolls.js@1.0.13/scrolls.js"></script>
<!-- Minified Version -->
<script src="https://cdn.jsdelivr.net/npm/scrolls.js@1.0.13/scrolls.min.js"></script>
```
